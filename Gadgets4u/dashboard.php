	 			...
	 			if(isset($_GET['parameter']))
	 			{
	 			    ...
	 			    foreach($products as $product)
	 			    {
	 					...
	 					{	
	 						...
	 						$totalorders = $_SESSION['totalorders']; 
	 						...
	 						?>		<h2 style="font-family:helvetica;color:brown;">Filter By</h2>
	 								<form action="updateorder.php" method="POST" id="filterform">
	 								<select name="filter" onchange="updatefilter();" id="filters">
	 									<option value="oldest">Oldest</option>
	 									<option value="maxprice">Maximum Order Price</option>
	 									<option value="latestdate">Latest Date</option>
	 								</select>
	 								</form>

	 							
	 							<table style="text-align:justify;padding:10px;" class="table">	
...
<script type="text/javascript">
	...
	option1.innerHTML = 'speaker';
	select.appendChild(option1);

	option2 = document.createElement('option');
	option2.value = 'headphone';
	option2.innerHTML = 'headphone';
	select.appendChild(option2);

	option3 = document.createElement('option');
	option3.value = 'laptop';
	option3.innerHTML = 'laptop';
